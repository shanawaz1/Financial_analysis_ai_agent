...
with demo:
    ...
    with gr.Tabs():
        ...
        with gr.TabItem("Model Explanations"):
            explanation_text = gr.Textbox(label="Input Text", lines=5, placeholder="Paste financial text here...")
            finbert_expl_html = gr.HTML(label="FinBERT Sentiment Explanation")
            explain_button = gr.Button("Generate Explanations")
            explain_button.click(explain_finbert, inputs=explanation_text, outputs=finbert_expl_html)
